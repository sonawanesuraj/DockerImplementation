...
ENV SPRING_DATASOURCE_URL=jdbc:postgresql://172.19.0.2:5432/dockerTest
ENV SPRING_DATASOURCE_USERNAME=postgres
ENV SPRING_DATASOURCE_PASSWORD=suraj@123
...
ARG JAR_FILE=/home/app/target/Docker-0.0.1-SNAPSHOT.jar
